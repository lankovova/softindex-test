 ...
 */
function sortArrayByProperty(whatToSort, sortByWhat) {
    return whatToSort.slice().sort(function (a, b) {
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(10),B=__webpack_require__(5),C=__webpack_require__(4),ba=__webpack_require__(11),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(14),ia=__webpack_require__(15),D=__webpack_require__(6);
...
var _UserForm = __webpack_require__(31);

var _UserForm2 = _interopRequireDefault(_UserForm);

var _UsersTable = __webpack_require__(41);
...
var App = function (_React$Component) {
    ...
    function App() {
        ...
        _this.onUserDelete = _this.onUserDelete.bind(_this);
        return _this;
    }

    _createClass(App, [{
        key: 'onUserAdd',
        value: function onUserAdd(user) {
            var _this2 = this;

            this.setState(function (prevState) {
                var userToAdd = Object.assign({}, user);
                userToAdd.id = prevState.nextUserId;

                return {
                    users: [].concat(_toConsumableArray(prevState.users), [userToAdd]),
                    nextUserId: prevState.nextUserId + 1
                };
            }, function () {
                // Update users in LS
                localStorage.setItem('users', JSON.stringify(_this2.state.users));
                localStorage.setItem('nextUserId', JSON.stringify(_this2.state.nextUserId));
            });
        }
    }, {
        key: 'onUserDelete',
        value: function onUserDelete(userId) {
            var _this3 = this;
            ...
            this.setState(function (prevState) {
                ...
                // Update users in LS
                localStorage.setItem('users', JSON.stringify(_this3.state.users));
                localStorage.setItem('nextUserId', JSON.stringify(_this3.state.nextUserId));
            });
        }
    }, {
        key: 'render',
...
var _TextInputField = __webpack_require__(32);
...
var UserForm = function (_React$Component) {
    ...
    function UserForm(props) {
        ...
        _this.handleUserCheckboxToggle = _this.handleUserCheckboxToggle.bind(_this);
        _this.handleUserTextInput = _this.handleUserTextInput.bind(_this);
        _this.handleSubmit = _this.handleSubmit.bind(_this);
        return _this;
    }

    _createClass(UserForm, [{
        key: 'handleUserCheckboxToggle',
        value: function handleUserCheckboxToggle(name, value) {
            this.setState(_defineProperty({}, name, value));
        }
    }, {
        key: 'handleUserTextInput',
        value: function handleUserTextInput(event) {
            var _this2 = this;
        ...
        value: function validateField(name, value) {
            ...
            this.setState(function (prevState) {
                var newInputStates = prevState.inputFieldsData;
        ...
        value: function validateForm() {
            ...
            Object.values(this.state.inputFieldsData).forEach(function (field) {
        ...
        key: 'handleSubmit',
        value: function handleSubmit(formSubmitEvent) {
            var _this4 = this;
            ...
            if (this.state.formIsValid) {
                ...
                this.props.onSubmit({
                    firstName: firstName, lastName: lastName, phone: phone, gender: gender, age: +age
                });

                this.clearFields();
            } else {
                // Validate all fields to show errors
                Object.values(this.inputFields).forEach(function (field) {
                    _this4.validateField(field.name, field.value);
                });
            }
        }
    }, {
        key: 'inputStateClass',
        value: function inputStateClass(state) {
            switch (state) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_TextInputField2.default, {
                    name: 'firstName',
                    ...
                    inputRef: function inputRef(el) {
                        return _this5.inputFields.firstName = el;
                    }
                }),
                _react2.default.createElement(_TextInputField2.default, {
                    name: 'lastName',
                    ...
                    inputRef: function inputRef(el) {
                        return _this5.inputFields.lastName = el;
                    }
                }),
                _react2.default.createElement(_TextInputField2.default, {
                    name: 'phone',
                    ...
                    inputRef: function inputRef(el) {
                        return _this5.inputFields.phone = el;
                    }
                }),
                ...
                _react2.default.createElement(_TextInputField2.default, {
                    ...
                    inputRef: function inputRef(el) {
                        return _this5.inputFields.age = el;
                    }
                }),
                _react2.default.createElement('input', { className: 'FormSubmit', type: 'submit', value: 'Add user' })
            );
        }
    }]);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                errors.map(function (error) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'InputError', key: error.toString() },
                        error
                    );
                })
            );
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!./TextInputField.css", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!./TextInputField.css");
...
// module
exports.push([module.i, ".FormInput {\r\n    width: 100%;\r\n    padding: 3px 5px;\r\n    margin: 7px 0;\r\n    outline: none;\r\n    border: none;\r\n    font-size: 14px;\r\n    border-bottom: 1px solid transparent;\r\n    border-color: lightgrey;\r\n    color:rgb(54, 54, 54);\r\n    transition: border-color 150ms ease-in-out;\r\n}\r\n\r\n/* Simulate outline */\r\ninput[type=text]:focus {\r\n    border-color: #0079ff;\r\n}\r\n\r\n.has-error {\r\n    /* Important to override focus styles */\r\n    border-color: red !important;\r\n}\r\n.no-error {\r\n    /* Important to override focus styles */\r\n    border-color: green !important;\r\n}\r\n\r\n.InputError {\r\n    font-size: 10px;\r\n    line-height: 11px;\r\n    color: red;\r\n    padding: 0 5px;\r\n}\r\n", ""]);
...
var Checkbox = function (_React$Component) {
    ...
    function Checkbox(props) {
        ...
        _this.onToggleCheckbox = _this.onToggleCheckbox.bind(_this);
        return _this;
    }
    ...
    _createClass(Checkbox, [{
        ...
        value: function onToggleCheckbox(event) {
            var _this2 = this;

            var name = event.target.name;

            this.setState(function (prevState) {
                var newCheckState = !prevState.isChecked;

                _this2.props.onToggleCheckbox(name, newCheckState);
        ...
        value: function render() {
            var _props = this.props,
                name = _props.name,
                label = _props.label,
                labelOnCheck = _props.labelOnCheck;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'label',
                    { className: 'FormCheckbox', htmlFor: label + labelOnCheck },
                    _react2.default.createElement('input', {
                        type: 'checkbox',
                        name: name,
...
// module
exports.push([module.i, ".FormCheckbox {\r\n    padding: 5px 10px;\r\n    font-size: 14px;\r\n    display: flex;\r\n    align-items: center;\r\n    user-select: none;\r\n}\r\n\r\n.FormCheckbox input[type=\"checkbox\"] {\r\n    margin-right: 5px;\r\n}\r\n", ""]);
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!./UserForm.css", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!./UserForm.css");
...
var _TableContent = __webpack_require__(45);
...
var Table = function (_React$Component) {
    ...
    _createClass(Table, [{
        key: 'sortBy',
        value: function sortBy(sortByWhat) {
            this.setState(function (prevState) {
                return {
                    sortedBy: sortByWhat,
        ...
        key: 'render',
        value: function render() {
            var usersList = (0, _utils.sortArrayByProperty)(this.props.users, this.state.sortedBy);
            ...
            return _react2.default.createElement(
                ...
                this.props.users.length === 0 ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(_TableContent2.default, {
                        items: usersList,
...
function TableHeader(_ref) {
    var sortTableBy = _ref.sortTableBy,
        sortedBy = _ref.sortedBy,
        isReversed = _ref.isReversed;

    var tableHeaderItems = [{ title: '#', propName: 'id' }, { title: 'First name', propName: 'firstName' }, { title: 'Last name', propName: 'lastName' }, { title: 'Phone', propName: 'phone' }, { title: 'Gender', propName: 'gender' }, { title: 'Age', propName: 'age' }];

    return _react2.default.createElement(
        'div',
        { className: 'TableHeader TableRow' },
        tableHeaderItems.map(function (item) {
            return _react2.default.createElement(TableHeaderItem, {
                key: item.propName.toString(),
                isSortedByThis: item.propName === sortedBy,
                isReversed: isReversed,
                title: item.title,
                onClick: function onClick() {
                    return sortTableBy(item.propName);
                }
            });
        }),
        _react2.default.createElement(
            'div',
            { className: 'TabelHeader-Item TableCell' },
            'Action'
        )
    );
}

function TableHeaderItem(_ref2) {
    var title = _ref2.title,
        _onClick = _ref2.onClick,
        isSortedByThis = _ref2.isSortedByThis,
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!./TableHeader.css", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!./TableHeader.css");
...
// module
exports.push([module.i, ".TableHeader {\r\n    border-bottom: 1px solid rgb(105, 105, 105);\r\n}\r\n\r\n.TableHeader .TabelHeader-Item {\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    font-weight: 900;\r\n}\r\n\r\n.TableHeader .TabelHeader-Item {\r\n    cursor: pointer;\r\n    color: rgb(158, 158, 158);\r\n    transition: color 100ms ease-in-out;\r\n    user-select: none;\r\n}\r\n\r\n.TableHeader .TabelHeader-Item:hover,\r\n.TableHeader .TabelHeader-Item:hover.sorted::after {\r\n    color: black;\r\n}\r\n\r\n.TableHeader .TabelHeader-Item:last-child {\r\n    color: rgb(158, 158, 158);\r\n    /* Important to rewrite table row style */\r\n    cursor: default !important;\r\n    user-select: none;\r\n}\r\n\r\n.TableHeader .TabelHeader-Item.sorted::after {\r\n    content: \">\";\r\n    font-size: 14px;\r\n    margin-left: 3px;\r\n    color: lightgrey;\r\n    transform: rotate(90deg);\r\n    transition: color 100ms ease-in-out;\r\n}\r\n\r\n.TableHeader .TabelHeader-Item.sorted.reversed::after {\r\n    transform: rotate(270deg);\r\n}\r\n", ""]);
...
function TableContent(_ref) {
    ...
    return _react2.default.createElement(
        ...
        items.map(function (item) {
            return _react2.default.createElement(TableUserItem, {
                key: item.id,
                user: item,
...
function TableUserItem(_ref2) {
    var user = _ref2.user,
        onItemDelete = _ref2.onItemDelete;
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!./TableContent.css", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!./TableContent.css");
...
// module
exports.push([module.i, ".TableContent .TableRow:nth-child(odd) {\r\n    background: #d5ffc4;\r\n}\r\n", ""]);
...
if(false) {
	module.hot.accept("!!../node_modules/css-loader/index.js!./UsersTable.css", function() {
		var newContent = require("!!../node_modules/css-loader/index.js!./UsersTable.css");
